...
- Assignment and contest lists use a compact status Tag. Contest lists and detail headers order colored contest kind, status, then title. Keep the relevant time or range in the status tooltip.
