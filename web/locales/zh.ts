export const zh = {
  ...
  problems: {
    ...
    currentHidden: '已隐藏',
    show: '显示题目',
    publishConfirm: '发布后不可再次隐藏或删除，确认题面与评测数据已经就绪？',
    shown: '已设为可见',
    time: '时间限制',
    memory: '内存限制'
  },
  ...
  assignments: {
    title: '作业',
    instructions: '作业说明',
    practiceRule: '截止前提交计入作业；截止后仍可复盘题目，新的提交作为普通练习，不再计入原作业。',
    locked: '已有提交或作业已截止，题目与成员范围已锁定；进行中仅可延长截止时间。',
    name: '标题',
    deadline: '截止时间',
    status: '状态',
    progress: '进度',
  ...
  contests: {
    ...
    description: '比赛说明',
    rules: '计分规则',
    oiRules: '每题取所有已完成评测中的最高分；比赛进行中隐藏榜单和评测结果，结束后公布。',
    icpcRules: '按通过题数排名，再比较罚时；每次通过前的错误提交增加 20 分钟罚时。若设置封榜时间，公开榜单在封榜后暂停更新。',
    locked: '比赛开始后规则与题目已锁定；进行中仅可延长结束时间。',
    name: '标题',
    kind: '赛制',
    time: '时间',
    status: '状态',
    problems: '题目',
    secretProblemsHint: '保密比赛只能使用从未发布、未用于作业或其他比赛且尚无提交/讨论的草稿题；赛后可发布，但不可再次作为赛题。',
    rank: '榜单',
    submissions: '提交',
    create: '创建比赛',
    running: '进行中',
