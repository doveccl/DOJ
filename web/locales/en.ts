...
export const en: typeof zh = {
  ...
  problems: {
    ...
    show: 'Show problem',
    publishConfirm: 'Published problems cannot be hidden or deleted. Is the statement and judge data ready?',
  ...
  assignments: {
    ...
    practiceRule: 'Submissions before the deadline count toward the assignment. After it ends, problems remain available for review and new submissions become ordinary practice.',
    locked: 'The problem and member scope is locked after the first submission or deadline. While active, only the deadline may be extended.',
    name: 'Title',
    deadline: 'Deadline',
    status: 'Status',
    progress: 'Progress',
  ...
  contests: {
    ...
    rules: 'Scoring rules',
    oiRules: 'Each problem uses the best completed score. Standings and results stay hidden while the contest is running and are published when it ends.',
    icpcRules: 'Participants rank by solved problems, then penalty. Each wrong attempt before acceptance adds 20 minutes. When configured, the public scoreboard stops updating at freeze time.',
    locked: 'Rules and problems are locked after the contest starts. While running, only the end time may be extended.',
    name: 'Title',
    kind: 'Format',
    time: 'Time',
    status: 'Status',
    problems: 'Problems',
    secretProblemsHint: 'Secret contests accept only unpublished drafts with no prior assignment, contest, submission, or discussion use. They may be published after the contest, but never reused as secret problems.',
    rank: 'Standings',
    submissions: 'Submissions',
