...
const zhCNMessages = {
  ...
  dashboard: {
    ...
    focusProblem: '推荐题目',
    focusProblemMeta: '{count} 人通过',
    focusContest: '比赛',
    focusAssignment: '作业',
    focusDiscussion: '讨论',
    focusSubmission: '最近提交',
    activeContest: '进行中',
    upcomingContest: '即将开始',
    noContest: '暂无比赛',
    noAssignment: '暂无作业',
    problems: '题目',
    submissions: '提交',
...
const enMessages = {
  ...
  dashboard: {
    ...
    workspaceTitle: 'Practice overview',
    workspaceIntro: 'Problems, contests, assignments, and submission activity.',
    ...
    focusProblem: 'Recommended problem',
    focusProblemMeta: '{count} solved',
    focusContest: 'Contest',
    focusAssignment: 'Assignment',
    focusDiscussion: 'Discussion',
    focusSubmission: 'Latest submission',
    activeContest: 'Active',
    upcomingContest: 'Upcoming',
    noContest: 'No contests',
