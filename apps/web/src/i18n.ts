...
const zhCNMessages = {
  ...
  admin: {
    ...
    problems: {
      ...
      rootResources: '根目录评测资源',
      rootCustomOnly: '根目录评测资源仅在 custom 模式下可编辑；default/strict 共用预构建判题镜像。',
      yes: '是',
      no: '否',
      statement: '题面',
      timeMs: '时间 ms',
...
const enMessages = {
  ...
  admin: {
    ...
    problems: {
      ...
      rootResources: 'Root judge resources',
      rootCustomOnly: 'Root judge resources are editable only in custom mode; default/strict use the prebuilt judge image.',
      yes: 'Yes',
      no: 'No',
      statement: 'Statement',
      timeMs: 'Time ms',
