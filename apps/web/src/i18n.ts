...
const zhCNMessages = {
  ...
  admin: {
    ...
    problems: {
      ...
      checker: 'Checker',
      interactor: '交互器',
      checkerTitle: '配置 Checker（特判）',
      checkerSource: 'Checker 源码（C++）',
      checkerEnabledHint: '该题已启用 Checker，可修改或移除。',
      checkerDisabledHint: '提供 C++ 特判源码以替代默认逐字符比对。',
      checkerRemove: '移除 Checker',
      checkerSaved: '题目 {id} 的 Checker 已保存。',
      checkerRemoved: '题目 {id} 的 Checker 已移除。',
      noData: '当前还没有测试数据',
...
const enMessages = {
  ...
  admin: {
    ...
    problems: {
      ...
      checkerTitle: 'Configure checker (special judge)',
      checkerSource: 'Checker source (C++)',
      checkerEnabledHint: 'A checker is enabled for this problem; edit or remove it.',
      checkerDisabledHint: 'Provide a C++ special judge to replace the default exact compare.',
      checkerRemove: 'Remove checker',
      checkerSaved: 'Checker saved for problem {id}.',
      checkerRemoved: 'Checker removed for problem {id}.',
