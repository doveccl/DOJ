...
CREATE TABLE "bbs_replies" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "bbs_replies_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "bbs_topics" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "bbs_topics_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"user_id" integer NOT NULL,
	"title" varchar(160) NOT NULL,
...
CREATE TABLE "problem_versions" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "problem_versions_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"problem_id" integer NOT NULL,
...
ALTER TABLE "bbs_replies" ADD CONSTRAINT "bbs_replies_topic_id_bbs_topics_id_fk" FOREIGN KEY ("topic_id") REFERENCES "public"."bbs_topics"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "problem_versions" ADD CONSTRAINT "problem_versions_testdata_file_id_files_id_fk" FOREIGN KEY ("testdata_file_id") REFERENCES "public"."files"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "problem_versions" ADD CONSTRAINT "problem_versions_checker_file_id_files_id_fk" FOREIGN KEY ("checker_file_id") REFERENCES "public"."files"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "problem_versions" ADD CONSTRAINT "problem_versions_interactor_file_id_files_id_fk" FOREIGN KEY ("interactor_file_id") REFERENCES "public"."files"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "bbs_replies_topic_idx" ON "bbs_replies" USING btree ("topic_id","created_at");--> statement-breakpoint
CREATE INDEX "bbs_topics_tags_idx" ON "bbs_topics" USING btree ("tags");--> statement-breakpoint
...
CREATE INDEX "judge_runners_enabled_idx" ON "judge_runners" USING btree ("enabled","sort_order");--> statement-breakpoint
...
CREATE UNIQUE INDEX "problems_slug_uidx" ON "problems" USING btree ("slug");--> statement-breakpoint
