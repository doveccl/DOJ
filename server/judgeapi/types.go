...
import common "github.com/doveccl/doj/common/judger"

type LeaseRequest = common.LeaseRequest
type LeaseResponse = common.LeaseResponse
type TaskPayload = common.TaskPayload
type LangPayload = common.LangPayload
type ProblemPayload = common.ProblemPayload
type LimitsPayload = common.LimitsPayload
