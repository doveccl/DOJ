...
type AdminSettings adminsvc.AdminSettings
type AdminSettingsPatch adminsvc.AdminSettingsPatch
type AdminUser adminsvc.User
type AdminUserPage adminsvc.PageResult[AdminUser]
type AdminUserUpdate adminsvc.UserUpdate
type AdminUserCreate adminsvc.UserCreate
type PasswordReset adminsvc.PasswordReset
type AdminGroup adminsvc.Group
type AdminGroupPage adminsvc.PageResult[AdminGroup]
type AdminGroupUpdate adminsvc.GroupUpdate
type AdminLang adminsvc.Language
type AdminLangUpdate adminsvc.LanguageUpdate
type AdminLangCreate adminsvc.LanguageCreate
type AdminJudger adminsvc.Judger
type AdminJudgeQueue adminsvc.JudgeQueue
...
type BackupSettings backupsvc.Settings
type BackupRunning backupsvc.Running
type BackupItem backupsvc.Item
