...
const cache = {
  user: {} as Cache<DUser | null>,
  problem: {} as Cache<DProblem | null>,
  contest: {} as Cache<DContest | null>
}
...
type Tables = 'user' | 'problem' | 'contest' | 'submission' | 'post' | 'file'
export function fetch(type: Tables): Middleware {
